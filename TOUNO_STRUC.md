...
1. **Entras en acuerdo con las sucursales para las que quieras trabajar.** Dos caminos, y valen
   ...
   acuerdos con varias empresas al mismo tiempo.
...
5. **Vas.** Desde ese momento el comprador ve tu recorrido en el mapa y puede escribirte por el chat
   del pedido.
6. **Escaneas el código del comprador** al llegar. Eso cierra el pedido.
...
- **Acuerdos** — invitaciones que te llegaron, postulaciones que enviaste, y con qué sucursales
  estás trabajando hoy.
- **Ganancias** — lo que llevas ganado, por día y por periodo.
...
- **Sabes cuánto ganas antes de aceptar**, no después.
- **Tu trabajo queda probado.** El escaneo del código es la constancia de que entregaste.
...
2. **Mantienes la carta.** Los platos, las descripciones, los precios y las categorías son de la
   empresa: se definen una vez y rigen en todas tus sucursales.
3. **Contratas riders.** Invitas a un rider y **eliges a qué sucursales tuyas queda asociado**. Ves
   quién aceptó, quién está pendiente y quién se postuló a ti.
4. **Miras las finanzas** de toda la marca junta, y comparas entre sucursales.
5. **Fijas los ajustes** que rigen para todos: tiempos de preparación por defecto, si se aceptan
   pedidos automáticamente, y demás.
...
Tus riders · Historial · Métricas de tu local · Ajustes de tu local.
...
- **No cambias precios ni creas platos.** La carta es de la empresa.
- **No invitas riders por tu cuenta**, pero sí ves quién se postuló a tu sucursal y trabajas con
  quien ya tiene acuerdo. _(Este punto es de los que más queremos revisar: dinos si en tu negocio el
  local debería poder contratar solo.)_
...
2. **Mantienes el catálogo.** Artículos, precios y categorías, una vez para toda la empresa.
3. **Contratas riders, de los dos tipos.** Los de moto y auto reparten en ciudad. **Los de camión
...
1. **Recibes la carga** y confirmas qué llegó.
...
Pedidos · Ficha del pedido · **Entradas** (las cargas que llegan a tu sucursal) · Escanear ·
Disponibilidad del catálogo · Tus riders · Historial · Métricas · Ajustes.
...
- **No entregas sin escanear el código del comprador.**
- **No cambias precios ni el catálogo.** Es de la empresa.
- **No decides cuántos pedidos junta un camión antes de salir.** Ese número lo fija la empresa.

---

## 9. Los cuatro recorridos de un pedido
...
| Fin                | Ve _Entregado_                | Entra al historial    | Suma a sus ganancias              |
...
| Llega a destino    | Es **notificado**: está en su sucursal        | —                         | Descarga y termina | **Recibe la carga**, y el chat pasa a ella |
...
| ------------------- | -------------------------------------------------------------- | ---------------------- | -------------------- |
| Llega a destino     | Es notificado; **el chat pasa a la sucursal**                  | Recibe la carga        | —                    |
...
## 10. Qué pasa cuando algo sale mal
